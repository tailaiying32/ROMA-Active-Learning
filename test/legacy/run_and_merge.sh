#!/bin/bash
# ==============================================================================
# ROMA Legacy Comparison - Submit and Auto-Merge
...
JOB_ID=$(sbatch --parsable --requeue --export=ALL,TIMESTAMP=$TIMESTAMP active_learning/test/legacy/run_comparison.slurm)
...
sbatch --dependency=afterok:$JOB_ID --export=ALL,TIMESTAMP=$TIMESTAMP active_learning/test/legacy/merge_results.slurm
